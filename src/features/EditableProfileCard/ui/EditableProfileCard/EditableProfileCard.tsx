            ...
            <div>
                {validateErrors?.length &&
                    validateErrors.map((err) => (
                        <p key={err} data-testid="EditableProfileCard.Error">
